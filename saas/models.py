...
class PricePolicy(models.Model):
    ...
    creawte_datetime = models.DateTimeField(verbose_name="创建时间", auto_now_add=True)
...
class Project(models.Model):
    ...
    creator = models.ForeignKey(verbose_name='创建者', to='Users', null=True, blank=True, on_delete=models.SET_NULL)
    create_datetime = models.DateTimeField(verbose_name='创建时间', auto_now_add=True)
    bucket = models.CharField(verbose_name='存储桶', max_length=128)
    bucket_region = models.CharField(verbose_name='存储桶区域', max_length=32)
...
class ProjectUser(models.Model):
    """项目参与者"""
    user = models.ForeignKey(verbose_name='参与者', to='Users', on_delete=models.CASCADE)
...
class Wiki(models.Model):
    ...
    parent = models.ForeignKey(verbose_name='父文章', to='Wiki', null=True, blank=True, on_delete=models.SET_NULL)
...
class FileBank(models.Model):
    ...
    name = models.CharField(verbose_name='文件夹名称', max_length=128, help_text="文件/文件夹名")
    ...
    parent = models.ForeignKey(verbose_name='父级目录', to='FileBank', related_name='child', null=True, blank=True,
                               on_delete=models.CASCADE)
    update_user = models.ForeignKey(verbose_name='最近更新者', to='Users', null=True, blank=True,
...
class IssuesType(models.Model):
    """问题类型"""
    DEFAULT_ISSUES_TYPE = ['任务', '修改错误', '功能']
    project = models.ForeignKey(verbose_name='项目', to='Project', on_delete=models.CASCADE)
...
class Issues(models.Model):
    ...
    assign = models.ForeignKey(verbose_name='指派', to='Users', related_name="task", null=True, blank=True,
                               on_delete=models.SET_NULL)
    attention = models.ManyToManyField(verbose_name='关注者', to='Users', related_name='observe', null=True, blank=True)
    ...
    parent = models.ForeignKey(verbose_name='父问题', to='self', related_name='child', null=True, blank=True,
                               on_delete=models.SET_NULL)
    creator = models.ForeignKey(verbose_name='创建者', to='Users', related_name='create_problems', null=True,
...
class IssuesReply(models.Model):
    ...
    reply_type = models.SmallIntegerField(verbose_name='', choices=reply_choices)

    issues = models.ForeignKey(verbose_name='', to='Issues', null=True, blank=True, on_delete=models.CASCADE)
    content = models.TextField(verbose_name='', )
    creator = models.ForeignKey(to='Users', related_name='create_reply', null=True, blank=True,
                                on_delete=models.CASCADE)
    create_datetime = models.DateTimeField(auto_now_add=True)
    reply = models.ForeignKey(to='IssuesReply', null=True, blank=True, on_delete=models.CASCADE)
...
class ProjectInvite(models.Model):
    ...
    period = models.IntegerField(verbose_name='有效期', choices=period_choice, null=True, blank=True, default=1440)
    create_datetime = models.DateTimeField(verbose_name='创建时间', auto_now_add=True)
    creator = models.ForeignKey(verbose_name='创建者', to='Users', related_name='create_invite', null=True, blank=True,
                                on_delete=models.CASCADE)
